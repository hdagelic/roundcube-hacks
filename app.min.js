/* ** * * ..  *  .* ... .* .. *  **   ... . . . * ...  ...
 ...
 This file contains a simple hack to change the click
 behaviour, and enable dragging of messages in a
 two-column display.

 By default, clicking on a message shows a preview,
 (on mouse down), and when we remove the preview pane
 mousedown triggers openins the message, making 
 dragging impossible.

 We change this by removing the preview timer, and
 copying a double click event to a click event!

 
 HOW TO USE
 - -- - - -
 
 If you have roundcube 1.4.11 you can use this file
 and if not, try to modify your original file
 ...
 C) vim app.js
    ...
    edit the file as shown here, search for "IRB hack" 
 ...
 D) If you have errors, return your backed up version!
...
function rcube_webmail()
{
  ...
  this.msglist_select = function(list)
  {
    ...
    if (selected && this.env.contentframe && !list.multi_selecting && !this.dummy_select) {
      ...
      // IRB hack this.preview_timer = setTimeout(function() { ref.msglist_get_preview(); }, preview_pane_delay);
    }
